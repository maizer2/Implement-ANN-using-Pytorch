...
from train.CNN.LeNet5.train_LeNet5_mul import train_LeNet5_mul
...
from train.GAN.VanilaGAN.train_VanilaGAN_mul import train_VanilaGAN
from train.GAN.DCGAN.train_DCGAN import train_DCGAN
from train.GAN.DCGAN.train_DCGAN_mul import train_DCGAN_mul
